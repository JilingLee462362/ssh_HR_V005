...
<body>
<!-- 将整个页面作为一个表单提交 -->
<form action="emr/pagingSearch_hr.action" method="post" id="mainform">
	<div id="container">
							...
							<tbody>
								...
								<c:forEach items="${requestScope.listEngageMajorRelease}" var="lemr">
									<tr>
										...
										<td><a href="emr/tochange.action?mreId=${lemr.mreId}">修改</a>/<a href="emr/deleteEngageInfo.action?mreId=${lemr.mreId}">删除</a></td>
									</tr>
								</c:forEach>
